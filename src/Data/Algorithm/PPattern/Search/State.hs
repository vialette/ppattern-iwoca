...
module Data.Algorithm.PPattern.Search.State
(
  -- * The @State@ type
  State(..)
...
where
  ...
  import qualified Data.Algorithm.PPattern.Search.State.Next                    as State.Next
  import qualified Data.Algorithm.PPattern.Search.State.Access                  as State.Access
  import qualified Data.Algorithm.PPattern.Search.State.Embedding               as State.Embedding
  import qualified Data.Algorithm.PPattern.Search.State.IncreasingFactorization as State.IncreasingFactorization
