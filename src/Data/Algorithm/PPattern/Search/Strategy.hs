...
module Data.Algorithm.PPattern.Search.Strategy
(
  -- * The @Strategy@ type
  Strategy
...
where
  ...
  import qualified Data.Algorithm.PPattern.Search.Strategy.Link  as Strategy.Link
  import qualified Data.Algorithm.PPattern.Search.Strategy.Link2 as Strategy.Link2
